...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="fruit.html"> Band Tampil</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="col-md-6">
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <p>
                            Dimana Akan ada FESTIFAL akan datang di bandung dengan band
                            band yang menarik dan sangat megah pada tanggal 28 mei 2023.
                          </p>
                          <div class="d-flex">
  ...
  <section class="service_section layout_padding ">
    <div class="container">
      <h2 class="custom_heading">Kelebihan</h2>
      ...
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">band ahmad dani</h5>
              <p class="card-text">
                bentar lagi
              </p>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">waliband</h5>
              <p class="card-text">
                besok
              </p>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Ceribel</h5>
              <p class="card-text">
                Mingdep.
              </p>
            </div>
  ...
  <section class="container-fluid footer_section">
    <p>
      Copyright &copy; 2023
      <a href="https://html.design/">Gilang Danuwindu J</a>
    </p>
  </section>
  <!-- footer section -->

  <script type="{{ ('asset/text/javascript')}}" src="js/jquery-3.4.1.min.js"></script>
